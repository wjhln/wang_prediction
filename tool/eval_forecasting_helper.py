...
def parse_arguments():
    ...
    parser.add_argument("--gt", default="../ground_truth_data/ground_truth_train.pkl", type=str, help="path to gt file")
    parser.add_argument("--forecast",
                        default="../out_trajectory/out_trajectory_train.pkl",
                        type=str,
    ...
    parser.add_argument("--features",
                        default="../features/forecasting_features_train.pkl",
                        type=str,
